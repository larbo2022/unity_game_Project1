...
public class PlayerTracker : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.position = Vector3.MoveTowards(transform.position, trackedObjet.position + Vector3.up * currentDistance - trackedObjet.forward * (currentDistance * 0.5f), updateSpeed * Time.deltaTime);
